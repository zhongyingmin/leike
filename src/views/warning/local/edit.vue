  ...
  <div class="local">
    <div class="local-content">
      <div class="form-wrapper">
        <div class="form-item">
          <div class="label-title">局部预警设置</div>
          <div class="botton-wrapper"></div>
        </div>
        <div class="form-item">
          <div class="label">形变预警阀值:</div>
        ...
        <div class="form-item">
          ...
          <el-select v-model="form.drawPictureId" multiple placeholder="请选择">
            <el-option
