<template>
  <div class="header">
    <div class="title-wrapper">
      <div class="logo"></div>
      <div class="title">地质灾害智能化监测预警平台</div>
    </div>
    ...
    <div class="right-wrapper">
      <div class="btns" @click="changeLan">
        <img v-show="languages == 'EN'" src="../../assets/images/en.png" alt="" />
        <img v-show="languages == 'ZH'" src="../../assets/images/zh.png" alt="" />
      </div>
      <div
        style="
          display: flex;
