  ...
  methods: {
    initChart1() {
      ...
      getShapeChangeValue().then((res) => {
        ...
        unwarp(self.chart1).on("mouseover", function(params) {
          // 鼠标移入
          ...
          unwarp(self.chart1).setOption({
            ...
            series: {
              ...
              symbol: 'circle',//折线点设置为实心点emptyCircle
              symbolSize: 8,
              lineStyle: {
                width: 3,
              },
        ...
        unwarp(self.chart1).on("mouseout", function(params) {
          // 鼠标移出
          // myChart.dispatchAction({
          //     type: 'downplay',
          //     seriesName: params.seriesName,
    ...
    initChart2() {
      ...
      getShapeChangeSpeed().then((res) => {
        ...
        unwarp(self.chart2).on("mouseover", function(params) {
          // 鼠标移入
          // myChart.dispatchAction({
          //     type: 'highlight',
          //     seriesName: params.seriesName,
        ...
        unwarp(self.chart2).on("mouseout", function(params) {
          // 鼠标移出
          // myChart.dispatchAction({
          //     type: 'downplay',
          //     seriesName: params.seriesName,
    ...
    initChart3() {
      ...
      getShapeChangeAccelerated().then((res) => {
        ...
        unwarp(self.chart3).on("mouseover", function(params) {
          // 鼠标移入
          // myChart.dispatchAction({
          //     type: 'highlight',
          //     seriesName: params.seriesName,
        ...
        unwarp(self.chart3).on("mouseout", function(params) {
          // 鼠标移出
          // myChart.dispatchAction({
          //     type: 'downplay',
          //     seriesName: params.seriesName,
