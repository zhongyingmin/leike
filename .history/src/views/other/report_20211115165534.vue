    ...
    <div class="report-content">
      ...
      <div class="form-wrapper">
        ...
        <div class="form-item">
          ...
          <div class="text-wrapper">
            <div v-for="(data, index) in checkedArr" :key="index">
              <div :key="'xb_chart' + index" :ref="'xb_chart' + index"></div>
              <div
                :key="'xbjs_chart' + index"
                :ref="'xbjs_chart' + index"
              ></div>
              <div
                :key="'xbjsd_chart' + index"
                :ref="'xbjsd_chart' + index"
              ></div>
            </div>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    initCharts() {
      let self = this;
      feature({ fids: this.checkedArr.join() }).then((res) => {
        console.log(res);
        ...
        for (let i = 0; i < data.xbData.length; i++) {
          chartChecked1 = echarts.init(self.$refs["xb_chart" + i]);
          chartChecked2 = echarts.init(self.$refs["xbjs_chart" + i]);
          chartChecked3 = echarts.init(self.$refs["xbjsd_chart" + i]);
