      ...
      <div class="flight-content">
        ...
        <div class="content-wrapper">
          <div class="header-wrapper">
            <div class="left"></div>
            <div class="right">
              <div class="confirm" @click="handleClick">{{$t('radarRound')}}</div>
              <div class="confirm" @click="handleAdd">{{$t('create')}}</div>
            </div>
          </div>
          <div class="table-wrapper">
            ...
            <div class="body">
              <div class="coll" v-for="(data, index) in tableData" :key="index">
                <div>{{ data.name }}</div>
                <div class="handle">
                  <div class="edit" @click="handleFlight(data)">{{$t('handle')}}</div>
                  <div class="edit" @click="handleRemove(data)">{{$t('handle')}}</div>
                </div>
              </div>
            </div>
          </div>
