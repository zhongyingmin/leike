  ...
  <div class="output">
    <div class="output-content">
      ...
      <div class="form-wrapper">
        <div class="form-item">
          <div class="label-title">{{ $t("output") }}</div>
        ...
        <div class="form-item">
          <div class="label">{{ $t("exportType") }}:</div>
          <div class="text-wrapper">
            <el-select v-model="form.exporttype" placeholder="请选择">
              <el-option
      ...
      exportFile(this.form).then((res) => {
        window.open(
          window.customENV.baseURL +
            `common/download?fileName=${encodeURI(res.data)}&delete=true`
        );
        loading.close();
      });
    },
