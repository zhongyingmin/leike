  ...
  <div class="history">
    <div class="history-content">
      <div class="header-wrapper">
        ...
        <div class="right">
          <div class="confirm" @click="handleExportArr">{{$t('batchExport')}}</div>
        </div>
      </div>
        ...
        <div class="body">
          <div class="coll" v-for="(data, index) in tableData" :key="index">
            ...
            <div class="handle">
              ...
              <div class="edit" @click="handleExport(data)">{{$t('export')}}</div>
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    handleAll() {
      ...
      if (this.status) {
        this.checkboxArr = this.tableData.map((data) => data.id);
      } else {
        this.checkboxArr = [];
      }
    },
