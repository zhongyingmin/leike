<template>
  <div class="action">
    <div class="app-right wrapper">
      <div class="header">
        <my-title :name="title"></my-title>
        <div class="size"></div>
      </div>
      <div class="content">
        <div class="form-item">
          <div class="label">坐标名称:</div>
        ...
        <div class="form-item">
          ...
          <div class="botton-wrapper">
            ...
            <div class="remove" @click="cancel">取消</div>
          </div>
        </div>
      </div>
    </div>
