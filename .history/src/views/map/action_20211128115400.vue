      ...
      <div class="content">
        ...
        <div v-show="type == 'line'">
          <div class="form-item">
            ...
            <div class="text-wrapper">{{ form.distance }}</div>
          </div>
          <div class="form-item">
            <div class="label">{{ $t("db_distance") }}:</div>
            <div class="text-wrapper">{{ form.db_distance }}</div>
          </div>
        </div>
        <div v-show="type == 'area'">
          <div class="form-item">
            <div class="label">{{ $t("mianji") }}:</div>
            <div class="text-wrapper">{{ form.mianji }}</div>
          </div>
          <div class="form-item">
            <div class="label">{{ $t("db_mianji") }}:</div>
            <div class="text-wrapper">{{ form.db_mianji }}</div>
          </div>
        </div>
        <div class="title">
          <div class="line"></div>
        ...
        <div class="form-item">
          <div class="label">{{ $t("pointColor") }}:</div>
          <div class="input-wrapper">
            ...
            <div class="tagColor-wrapper">
              <div
                :style="{
                  ...
                  height: '15px',
                  marginRight: '5px',
                  background: form.pointColor,
                }"
              ></div>
              <div>{{ form.pointColor }}</div>
            </div>
            <el-color-picker
              v-model="form.pointColor"
              @change="mapUpdate"
              size="mini"
            ></el-color-picker>
          </div>
        ...
        <div class="form-item" v-show="type == 'line' || type == 'area'">
          <div class="label">{{ $t("fontColor") }}:</div>
          <div class="input-wrapper">
            <div class="tagColor-wrapper">
              <div
                :style="{
                  ...
                  height: '15px',
                  marginRight: '5px',
                  background: form.fontColor,
                }"
              ></div>
              <div>{{ form.fontColor }}</div>
            </div>
            <el-color-picker
    ...
    rules(form) {
      ...
      if (this.type == "area") {
        if (Number(form.mianji) > 6000) {
          ...
          this.$sendIframe("removeGraphic", form);
