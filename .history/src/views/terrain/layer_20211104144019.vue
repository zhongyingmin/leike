    ...
    <div class="app-right wrapper">
      <div class="content-wrapper">
        <div class="r1" v-show="!dataItem[1].input">
          <div class="header">
            <my-title name="形变值"></my-title>
          </div>
          <div class="content">
            <div class="form-item">
              <div class="label">形变最小值:</div>
        ...
        <div class="r2" v-show="!dataItem[2].input">
          <div class="header">
            <my-title name="形变速度值"></my-title>
          </div>
          <div class="content">
            <div class="form-item">
              <div class="label">形变速度最小值:</div>
              <div class="input-wrapper">
                <input
                  type="text"
        ...
        <div class="r3" v-show="!dataItem[3].input">
          <div class="header">
            <my-title name="形变加速值"></my-title>
          </div>
          <div class="content">
            <div class="form-item">
              <div class="label">形变加速最小值:</div>
              <div class="input-wrapper">
                <input
                  type="text"
