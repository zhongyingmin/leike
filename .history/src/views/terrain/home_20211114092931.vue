  ...
  <div class="home" ref="imageDom">
    <div class="app-left wrapper">
      ...
      <div v-show="lshow" class="content-wrapper">
        <div class="l1">
          <div class="header">
            <my-title :name="$t('shapeCurve')" @click="onClickRight"></my-title>
            <div
              class="size"
...
export default {
  ...
  methods: {
    onClickRight() {
      html2canvas(document.body,{scale:2,logging:false,useCORS:true}).then((canvas) => {
        // 转成图片，生成图片地址
