  ...
  <div class="home">
    <div class="app-left wrapper">
      ...
      <div v-show="lshow" class="content-wrapper">
        <div class="l1">
          <div class="header">
            <my-title :name="$t('shapeCurve')" @click="printPdf"></my-title>
            <div
              class="size"
    ...
    <div class="app-right wrapper">
      ...
      <div v-show="rshow" class="content-wrapper">
        <div class="r1">
          <div class="header">
            <my-title :name="$t('warningStatistics')"></my-title>
            <div
              class="size"
              @click="handleClick($t('warningStatistics'), 'chart6')"
            ></div>
          </div>
          <div class="content">
        ...
        <div class="r2">
          <div class="header">
            <my-title :name="$t('warningType')"></my-title>
            <div
              class="size"
              @click="handleClick($t('warningType'), 'chart5')"
            ></div>
          </div>
        ...
        <div class="r3">
          <div class="header">
            <my-title :name="$t('warningShuffling')"></my-title>
            <!-- <div class="size"></div> -->
          </div>
    ...
    <Popup v-model="popupShow" :title="title" :refId="refId" :key="tid" />
  </div>
</template>
...
export default {
  ...
  methods: {
    printPdf() {
      ...
      // target.style.background = "#FFFFFF";
      const iframe = document.getElementById("iframe_key").contentWindow.document.body;
