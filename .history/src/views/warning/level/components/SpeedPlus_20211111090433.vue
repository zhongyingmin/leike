    ...
    <div class="item-wrapper" v-show="menuIndex == 0">
      <div class="item" v-for="(data, index) in form" :key="index">
        <div class="left-wrapper">
          <div class="label" v-if="index == 0">{{$t('LevelOne')}}:</div>
          <div class="label" v-if="index == 1">{{$t('LevelTwo')}}:</div>
          <div class="label" v-if="index == 2">{{$t('LevelThree')}}:</div>
          <div class="label" v-if="index == 3">{{$t('LevelFour')}}:</div>
