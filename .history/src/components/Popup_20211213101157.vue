  ...
  <div class="popup" v-show="modelValue">
    <div class="popup-content">
      ...
      <div class="header-wrapper">
        ...
        <!-- <div class="botton-export" @click="handleExport" v-show="title != '形变值曲线'&&title != '形变速度值曲线'&&title != '形变加速值曲线'">
          数据导出
        </div> -->
        <div
          class="botton-export"
          ...
          v-show="
            title != $t('shapeCurve') &&
              title != $t('shapeSpeedCurve') &&
              title != $t('shapeAcceleratedCurve')
          "
        >
          {{ $t("output") }}
        </div>
      </div>
      <div class="tool-wrapper" v-show="title != $t('warningType')">
        <el-date-picker
          v-model="date"
          @change="handleChange"
          :disabled="!disabled"
    ...
    initChart() {
      ...
      switch (ref) {
        ...
        case "chart4":
          ...
          break;
        case "chart5":
          this.emitter.emit("initLamp", true);
